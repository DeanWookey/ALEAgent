...
public class Wavelets {
   ...
   /** Number of the stored highervalued (leftmost) bits of the mantissa of a double value.
     ...
     * @see #accuracyBitMask
     */
   public static final int accuracyBits = 10; // float mantissa has 22 bits
    ...
    *  We have 0 <= k < 2N.
    *  In the i-th row (0 <= i < 10) there are the 2(i+1)=2N coefficients of D2<i>N</i>.
    */
    ...
    *  We have 0 <= j < 2N.
    *  In the i-th row (0 <= i < 10) there are the 2(i+1) - 1 = 2N - 1 initial values of D2<i>N</i>.
    */
   ...
   private static java.util.TreeMap<Double,Double> phiValues = new java.util.TreeMap<Double,Double>();
  
   /** 
    * returns the value of the scaling function <sub><i>N</sub>&#x3C6;</i>(<i>x</i>) of the 
   ...
   /** 
    * returns the function value of the Daubechies wavelet <sub><i>N</sub>&#x3C8;</i>(<i>x</i>) 
    * of the Daubechies class D<i>N</i>, where <N> = 2, 4, ..., 20.
    * The computation uses the scaling function <sub><i>N</sub>&#x3C6;</i>(<i>x</i>).
    *
    * @param N the index of the Daubechies wavelet class D2 ... D20, 
    ...
    *          <tr>
    *            <td>
    *              <table border="1"><tr><td>null</td></tr></table>
    *            </td>
    *          </tr>
    *        </table>
    *     </td>
    ...
    *          <tr>
    *            <td>
    *              <table border="1"><tr><td>a[0]</td><td>a[1]</td><td> ... </td><td>a[2<sup><i>n</i></sup> - 1]</td></tr></table>
    *            </td>
    *          </tr>
    *        </table>
    *     </td>
...
//if( a.length == 2 && k==1 ) System.out.println("### c_"+k+"="+c[k]/2+" (c_1="+(-27+3*SQRT3)/32+")");
    ...
    *         = 0 otherwise.
    *  </pre>
    * See <a href="http://haegar.fh-swf.de/Publikationen/Wavelets.pdf" target="_top">http://haegar.fh-swf.de/Publikationen/Wavelets.pdf</a> 
    * for details.
    */
...
//      int _N = N/2 - 1;
//      String ausgabe = "<html><table border=\"1\">";
//      for (int i = 1; i <= N - 2; i++) {
//         ausgabe += "<tr>";
//         for (int j = 1; j <= N - 2; j++) {
//            ausgabe += "<td>";

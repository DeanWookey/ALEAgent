 ...
 * @author Dean
 */
public class IndependentHaarFunctionApproximation extends FunctionApproximator {

    private final int maxScale;
    private final int baseScale;
    private final int dimensions;

    public IndependentHaarFunctionApproximation(int baseScale, int maxScale, int dimensions) {

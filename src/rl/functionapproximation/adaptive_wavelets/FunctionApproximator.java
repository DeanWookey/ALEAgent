...
public class FunctionApproximator implements Serializable {
    ...
    public FunctionApproximator(BasisFunction terms[], int numFeatuers) {
        this.terms = terms;
    ...
    public FunctionApproximator(int numTerms, int numFeatures) {

 ...
 */
public class NoTransformGeneralAgent extends GeneralAgent {
    ...
    public NoTransformGeneralAgent(boolean gui, String game, String pipeBasename, int imageWidth, int imageHeight) {

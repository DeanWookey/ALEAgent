 ...
 */
public class FourierGeneralAgent extends TransformAgent {
    ...
    public FourierGeneralAgent(boolean gui, String game, String pipeBasename, int imageWidth, int imageHeight) {
    ...
    protected BasisFunction[] getTransformBasis() {
        return new FullFourierBasis(1, imageWidth, imageHeight, 10).getBasisFunctions();
    }
